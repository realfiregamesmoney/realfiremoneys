-- Create default configurations for Partnership / Affiliate Funnel
DO $$ 
BEGIN
    -- Cutoff score
    INSERT INTO public.app_settings (key, value)
    VALUES ('parceria_cutoff', '10')
    ON CONFLICT (key) DO NOTHING;

    -- WhatsApp number
    INSERT INTO public.app_settings (key, value)
    VALUES ('parceria_whatsapp', '+5511999999999')
    ON CONFLICT (key) DO NOTHING;

    -- Questions JSON
    INSERT INTO public.app_settings (key, value)
    VALUES ('parceria_questions', '[
        {
            "id": "q1",
