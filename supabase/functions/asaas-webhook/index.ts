...
serve(async (req) => {
  ...
  try {
    ...
    // Tenta extrair o ID do usuário da descrição "Deposito Real Fire - ID: xxxxx"
    // O código anterior gerou assim: `Deposito Real Fire - ID: ${user_id}`
    ...
    // 1. VERIFICAR SE O MODO AUTOMÁTICO ESTÁ LIGADO
